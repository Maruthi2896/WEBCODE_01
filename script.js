...
footer.innerText="By maruthi K j"
...
async function getNationalise(){
    try{
       ...
       <input id="searchInput"style='margin-left:30px;margin-top:30px;' type="text">
       <div class="row data ">
       ...
       <div class="col-md-4 mt-30 image">
        ...
        <div class="filterItems">
          ...
          <p id="item1"class="card-title fItems" style="font-size:40px">Name: ${name}</p>
          <p  id="item2"class="card-text m-0 fItems "><small class="text-muted">Country:Id-1 <b>${data.country[0].country_id}</b> And Probability is <b>${data.country[0].probability*100}%</b></small></p>
          <p id="item3" class="card-text m-0 fItems"><small class="text-muted">Country:Id-2 <b>${data.country[1].country_id} </b>And  Probability is <b>${data.country[1].probability*100}%</b></small></p>
          <p  id="item4"class="card-text m-0 fItems "><small class="text-muted">Country:Id-1 <b>${data.country[2].country_id}</b> And Probability is <b>${data.country[2].probability*100}%</b></small></p>
    ...
    search.addEventListener("onkeyup",(e)=>{
        ...
        fItems = document.getElementsByClassName("fItems");
